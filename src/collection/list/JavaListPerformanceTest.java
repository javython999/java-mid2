...
public class JavaListPerformanceTest {
    ...
    private static void addFirst(List<Integer> lsit, int size) {
        long startTime = System.currentTimeMillis();
    ...
    private static void addMid(List<Integer> lsit, int size) {
        long startTime = System.currentTimeMillis();
    ...
    private static void addLast(List<Integer> lsit, int size) {
        long startTime = System.currentTimeMillis();

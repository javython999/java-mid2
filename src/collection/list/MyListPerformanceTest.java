...
public class MyListPerformanceTest {
    ...
    private static void addFirst(MyList<Integer> lsit, int size) {
        long startTime = System.currentTimeMillis();
    ...
    private static void addMid(MyList<Integer> lsit, int size) {
        long startTime = System.currentTimeMillis();
    ...
    private static void addLast(MyList<Integer> lsit, int size) {
        long startTime = System.currentTimeMillis();
